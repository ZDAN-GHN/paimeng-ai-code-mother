...
**TS Agent 架构优雅化第一批进行中（父 issue #15）**：#16 目录收敛 ✅（2026-09-08，零行为变更 148/148）；frontier = #17 真流式 / #18 zod / #20 重试（已解锁，#17 与 #18 同文件须串行）；#19 等 #18，#21 收尾；XState 双轨决策 #22 待拍板（见 `ts-agent.md`）。
