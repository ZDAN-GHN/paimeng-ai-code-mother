...
> **⚠️ 历史参考（2026-09-03 起）**：Python Agent 已定稿**全面退役**（Agent 能力迁移 TypeScript），本文不再是架构权威。权威设计见 `docs/ts_agent/architecture.md`；退役决策与过渡方案见其 §0/§10。本文的契约细节（§1）、提示词位置、验证记录保留作为 **TS 移植的参考源**。
