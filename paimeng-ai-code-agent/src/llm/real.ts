// 真实 LLM provider（四档接线）：两渠道 OpenAI 兼容 API 统一封装为
...
//   ② 阿里云 DashScope Coding（标准/深度档）——coding.dashscope.aliyuncs.com/v1，qwen3.6-plus / qwen3.7-plus
...
// ② 错误归一化（仅 chat/completions 非流式响应）：部分上游错误会以
