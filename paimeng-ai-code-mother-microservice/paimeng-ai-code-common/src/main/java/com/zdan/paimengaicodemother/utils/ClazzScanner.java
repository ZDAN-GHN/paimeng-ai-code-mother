...
public class ClazzScanner {
    ...
    public static <T> Set<Class<? extends T>> scanInterfaces(
        ...
        String packageName = ClazzScanner.class.getPackageName(); // com.zdan.paimengaicodemother.utils
        // 查找最后一个点号的位置
        int lastDotIndex = packageName.lastIndexOf('.');
        String rootPackage = packageName.substring(0, lastDotIndex); // com.zdan.paimengaicodemother
        return scanInterfaces(rootPackage, annotationClass, interfaceClass);
    }
