package com.zdan.paimengaicodescreenshot.utils;
...
public class WebScreenshotUtils {
    ...
    public static void cleanupTempFiles() {
        ...
        for (int i = 0; i < MAX_LOOP && !deleted; i++) {
            try {
                deleted = FileUtil.clean(System.getProperty("user.dir") + "/tmp/screenshots");
            } catch (Exception e) {
    ...
    public static String saveWebPageScreenshot(String webUrl) {
        ...
        try {
            String rootPath =
                    System.getProperty("user.dir") + "/tmp/screenshots/" + UUID.randomUUID().toString().substring(0, 8);
