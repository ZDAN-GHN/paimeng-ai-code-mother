...
import com.zdan.paimengaicodemother.langgraph4j.node.concurrent.*;
    ...
    public CompiledGraph<MessagesState<String>> createWorkflow() {
        try {
            return new MessagesStateGraph<String>()
                    ...
                    // 添加边
                    .addEdge(GraphDefinition.START, "image_plan")
                    ...
                    .addConditionalEdges("code_quality_check",
                            ...
                            Map.of(
                                    ...
                                    "skip_build", GraphDefinition.END,
                                    "fail", "code_generator"
                            ))
                    .addEdge("project_builder", GraphDefinition.END)
                    .compile();
        } catch (GraphStateException e) {
            log.error("failed to create workflow, cause by ", e);
